...
class RegisterController extends AbstractController
{
    ...
    public function createUser(UserPasswordHasherInterface $passwordHasher, Request $request, EntityManagerInterface $manager, MailerInterface $mailer): Response
    {
        $user = new User();
